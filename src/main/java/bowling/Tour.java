...
public class Tour {
	...
	public boolean estStrike(){
		return nbQuilleTombeesLancer1 == PartieMonoJoueur.Nbre_Quilles;
	}

	public boolean estSpare(){
		return numCoup == 2 && nbQuilleTombeesLancer1+nbQuilleTombeesLancer2 == PartieMonoJoueur.Nbre_Quilles && numTour != PartieMonoJoueur.Nbre_Tours;
	}
	...
	public void lancer(int valeur){
		switch (numCoup){
			case 1:
				...
				if (nbQuilleTombeesLancer1 == PartieMonoJoueur.Nbre_Quilles && numTour != PartieMonoJoueur.Nbre_Tours) estFini = true;
				else if (nbQuilleTombeesLancer1 == PartieMonoJoueur.Nbre_Quilles) numCoup += 1;
				else numCoup++;
				break;
			case 2:
				...
				if (numTour == PartieMonoJoueur.Nbre_Tours) {
					if (!(nbQuilleTombeesLancer1+nbQuilleTombeesLancer2 < PartieMonoJoueur.Nbre_Quilles)){
						numCoup++;
						estFini = false;
					}
				}
